(() => {
  ...
  function addControls(){
    ...
    style.textContent='.audio-range{margin-top:6px;padding:9px 11px;border:1px solid rgba(255,255,255,.84);border-radius:14px;background:rgba(255,255,255,.86);box-shadow:0 8px 22px rgba(52,94,74,.11);backdrop-filter:blur(14px)}.audio-range label{display:flex;justify-content:space-between;gap:8px;margin-bottom:6px;color:#516b5e;font-size:.73rem}.audio-range input{width:100%;accent-color:#55c987}.play-panel{background:linear-gradient(145deg,rgba(214,247,231,.62),rgba(188,235,221,.54))!important;border:1px solid rgba(255,255,255,.72)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.52),0 14px 34px rgba(52,94,74,.12)!important;backdrop-filter:blur(16px) saturate(1.18);-webkit-backdrop-filter:blur(16px) saturate(1.18)}.stage{background:linear-gradient(180deg,rgba(255,255,255,.08),rgba(105,199,160,.06));border-radius:30px}';
